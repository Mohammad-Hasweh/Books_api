...
server_erorr=HTTPException(status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,detail="Something went wrong")
...
class  TagService():
    ...
    async def add_tags_to_book(self,book_uid:str,tag_data:TagAddModel,session:AsyncSession):
        ...
        #refreshes the book object to ensure it reflects the latest changes from the database.
